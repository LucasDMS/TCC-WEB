...
class ControllerProduto{
    ...
    public function __construct(){
        require_once($_SERVER['DOCUMENT_ROOT'] . "/cms" . "/model/Produto.php");
        ...
        require_once($_SERVER['DOCUMENT_ROOT'] . "/cms" . "/model/TabelaNutricional.php");
        require_once($_SERVER['DOCUMENT_ROOT'] . "/cms" .'/dao/ProdutoDAO.php');
