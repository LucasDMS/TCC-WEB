...
class ControllerEstabelecimento{
    ...
    public function __construct(){
        ...
        require_once($_SERVER['DOCUMENT_ROOT'] . '/empresa/dao/EstabelecimentoDAO.php');
        require_once($_SERVER['DOCUMENT_ROOT'] . '/empresa/model/Estabelecimento.php');
        require_once($_SERVER['DOCUMENT_ROOT'] . '/empresa/view/components/imagem.php');
